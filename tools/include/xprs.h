 ...
 *                                                                         *
 * (c) 1984-2009 Fair Isaac Corporation                                    *
 * For FICO Xpress Optimizer v20.00.11                                     *
 *                                                                         *
\***************************************************************************/
...
int XPRS_CC XPRSsetcbbariteration(XPRSprob prob, void (XPRS_CC *f_evaluate)(XPRSprob prob, void* vContext, int* barrier_action), void* p);
int XPRS_CC XPRSgetcbbariteration(XPRSprob prob, void (XPRS_CC **f_evaluate)(XPRSprob prob, void* vContext, int* barrier_action), void** p);
...
int XPRS_CC XPRS_bo_setcbmsghandler(XPRSbranchobject obranch, int (XPRS_CC *f_msghandler)(XPRSobject vXPRSObject, void* vUserContext, void* vSystemThreadId, const char* sMsg, int iMsgType, int iMsgCode), void* p);
