...
find_path(LTDL_INCLUDE_DIR ltdl.h /usr/local/include /usr/include C:/Program\ Files/GnuWin32/include)

if(LTDL_INCLUDE_DIR)
  find_library(LTDL_LIBRARIES
  NAMES ltdl
  PATHS /usr/local/lib /usr/lib C:/Program\ Files/GnuWin32/lib
  )
  if(LTDL_LIBRARIES)
    ...
    macro(_find_check_libs _library_name _function_name _lib _have_lib)
      ...
      ${_lib}
      NAMES ${_library_name}
      PATHS /usr/local/lib /usr/lib C:/WINDOWS/system32
      )
      if(${_lib})
        set(${_have_lib} ON)
      endif(${_lib})
  ...
  _find_check_libs(Kernel32 LoadLibrary LTDL_LTDL_ADDLIB4 LTDL_LTDL_HAVE_ADDLIB4)
  if(LTDL_LTDL_HAVE_ADDLIB4)
    set(LTDL_LIBRARIES ${LTDL_LIBRARIES} ${LTDL_LTDL_ADDLIB4})
    set(LTDL_FOUND ON)
  endif(LTDL_LTDL_HAVE_ADDLIB4)
...
LTDL_LTDL_ADDLIB4 LTDL_LTDL_HAVE_ADDLIB4
)
