...
int load_module(){
    ...
    if (!module) module = g_module_open_all("cplex111", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex110", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex102", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex101", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex100", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex91", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex90", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex81", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex80", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex75", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex71", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex70", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex66", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex65", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex60", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex50", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex40", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex30", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex21", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    if (!module) module = g_module_open_all("cplex20", G_MODULE_BIND_LAZY|G_MODULE_BIND_LOCAL);
    return (module != NULL);
}
